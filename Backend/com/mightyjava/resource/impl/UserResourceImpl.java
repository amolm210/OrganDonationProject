...
public class UserResourceImpl {
	...
	public ResponseEntity<String> register(@RequestBody User user) {
		...
		try {
			...
			//
			// Add get role functionality here
			//
			//user.getTRole();
			//System.out.println("user.getRole().getName()");
			//System.out.println(user.getRole().getName());
			if((user.getRole().getName()).equals("DONAR")) {
				user.setRole(roleRepository.findByName(ConstantUtils.DONAR.toString()));
			}
			else {
	...
	public ResponseEntity<String> authenticate(@RequestBody User user) {
		...
		try {
			...
			if (authentication.isAuthenticated()) {
				...
				System.out.println(userRepository.findByEmail(email).getRole().getName());
