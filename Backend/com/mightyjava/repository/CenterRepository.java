...
public interface CenterRepository extends PagingAndSortingRepository<Center, Long> {
    ...
    @Query("FROM Center b WHERE b.name LIKE %:searchText% OR b.city LIKE %:searchText% OR b.mobile LIKE %:searchText% ORDER BY b.name ASC")
    Page<Center> findAllBooks(Pageable pageable, @Param("searchText") String searchText);
...
//    @Query(value = "UPDATE matching_table m SET donar_organ =:organ, donar_bg =:blood WHERE m.patient_organ=:organ", nativeQuery = true)
//    Page<Center> findAllBooks( Pageable pageable,@Param("blood") String blood, @Param("city") String city, @Param("organ") String organ);
//    
//    
    
//    @Query(value = "UPDATE matching_table SET donar_organ = organ, donar_bg = blood WHERE patient_organ=organ", nativeQuery = true)
//    Page<Center> matchAllPairs(Pageable pageable, @Param("bg") String bg, @Param("city") String city, @Param("organ") String organ);
//         
//
